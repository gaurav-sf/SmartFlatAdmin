...
public class MainVisirtorFragment  extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater,
        ...
        mTabHost.addTab(
                mTabHost.newTabSpec("tab1").setIndicator(getTabIndicator(mTabHost.getContext(), R.string.new_visitor)),
                NewVisitorFragment.class, null);
        mTabHost.addTab(
                mTabHost.newTabSpec("tab2").setIndicator(getTabIndicator(mTabHost.getContext(), R.string.visited_visitor)),
                VisitedVisitorFrgament.class, null);
        return rootView;
	}

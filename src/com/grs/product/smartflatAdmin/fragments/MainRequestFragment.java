...
public class MainRequestFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
        ...
        mTabHost.addTab(
                mTabHost.newTabSpec("tab1").setIndicator(getTabIndicator(mTabHost.getContext(), R.string.new_request)),
                NewRequestFragment.class, null);
        mTabHost.addTab(
                mTabHost.newTabSpec("tab2").setIndicator(getTabIndicator(mTabHost.getContext(), R.string.closed_request)),

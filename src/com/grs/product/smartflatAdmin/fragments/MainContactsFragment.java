...
public class MainContactsFragment  extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
        ...
        mTabHost.addTab(
                ...
                AddNewContactFragment.class, null);
        mTabHost.addTab(
                mTabHost.newTabSpec("tab2").setIndicator(getTabIndicator(mTabHost.getContext(), R.string.added)),
                AddedContactsFragment.class, null);
        return rootView;
	}
